...
public class TerrainManager {
	 ...
	 * @throws IOException
	 */
	public void saveTerrain(File saveFile, Location l1, Location l2) throws DataException, IOException, com.sk89q.worldedit.FilenameException {
	 ...
	 */
	public void loadSchematic(File saveFile, Location loc) throws DataException, IOException, MaxChangedBlocksException, EmptyClipboardException, com.sk89q.worldedit.FilenameException {
		saveFile = we.getSafeSaveFile(localPlayer,
		                              saveFile.getParentFile(), saveFile.getName(),
		                              EXTENSION, new String[] { EXTENSION });
	 ...
	 * @throws EmptyClipboardException
	 */
	public void loadSchematic(File saveFile) throws com.sk89q.worldedit.FilenameException, DataException, IOException, MaxChangedBlocksException, EmptyClipboardException {
